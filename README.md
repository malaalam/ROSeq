...
The R code used for producing differential analysis results with methods like SCDE, ROTS, MAST and Wilcoxon-Rank Sum is also available for download in the directory "04_R_code.zip" available in the **Release** section of the repository, in case one wishes to reproduce the results.
